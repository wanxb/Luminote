...
export function getHomeLayoutOptions(
  ...
  return [
    {
      value: "masonry",
      label: messages.masonry,
      description: messages.masonryDescription,
    },
    {
      value: "editorial",
      label: messages.editorial,
      description: messages.editorialDescription,
    },
    {
      value: "spotlight",
      label: messages.spotlight,
      description: messages.spotlightDescription,
    },
  ];
}
...
export const WATERMARK_POSITION_OPTIONS: Array<{
  ...
  label: string;
}> = getWatermarkPositionOptions("zh-CN");
export const HOME_LAYOUT_OPTIONS: Array<{
  value: HomeLayout;
  label: string;
  description: string;
}> = getHomeLayoutOptions("zh-CN");
